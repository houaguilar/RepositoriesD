...
//    abstract fun insertContributors(contributors: List<Contributor>)
    ...
    @Insert(onConflict = OnConflictStrategy.REPLACE)
    abstract fun createRepoIfNoExist(repo: Repo): Long
...
//    abstract fun loadContributors(owner: String, name: String): LiveData<List<Contributor>>
    ...
    abstract fun search(query: String): LiveData<List<RepoSearchResult>>

    //Devuelve una lista de repositorios ordenadas por el Id
